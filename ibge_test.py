...
class TestIBGE(unittest.TestCase):
    ...
    def test_locations_per_aggregate_query(self):
        ...
        query.select_location_levels([7, 6])
    ...
    def test_periods_per_aggregate_query(self):
        query = IBGEQuery()
        query.select_aggregate(1705)
        query.filter_periods()
        assert query.url() == 'https://servicodados.ibge.gov.br/api/v3/agregados/1705/periodos'

    def test_variable_query(self):
        query = IBGEQuery()
        query.select_aggregate(1705)
        query.filter_periods()
        query.select_periods(-6)
        query.filter_variables()
        query.select_locations('BR')
        assert query.url() == 'https://servicodados.ibge.gov.br/api/v3/agregados/1705/periodos/-6/variaveis?localidades=BR'